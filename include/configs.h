...
#define DEFAULT_ALT_SCENE_ACCEL 30.
#define DEFAULT_AZI_SCENE_ACCEL 30.
...
#define BATTERY_R1_kOHM 150.
#define BATTERY_R2_kOHM 10.
#define BATTERY_VOLTAGE_DIVIDER_FAC ((BATTERY_R2_kOHM+BATTERY_R1_kOHM)/BATTERY_R2_kOHM)
#define DEFAULT_MIN_BATTERY_LEVEL 20.


#define MAX_LOG_FILES 120
// Delete a log file after number of days, -1 to keep everything
#define DEFAULT_LOG_DELETE_AFTER_DAYS -1
